...
$detail = query("SELECT * FROM pembayaran JOIN pembelian ON pembayaran.id_pembelian = pembelian.id_pembelian WHERE pembayaran.id_pembelian ='$id_pembelian'")[0];
...
<body>
    ...
    <section id="pembayaran">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="../assets/img//bukti_pembayaran/<?= $detail['bukti']; ?>" alt="<?= $detail['bukti']; ?>" class="img-responsive" width="200">
                </div>
            </div>
    ...
    if (isset($_POST['proses'])) {
        ...
        echo "<script>location='dataPesanan.php'</script>";
    }
