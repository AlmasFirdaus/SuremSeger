    ...
    <section id="product">
        <div class="container">
            <div class="row">
                ...
                <div class="tambahProduk mb-4">
                    <a href="tambahProduk.php" class="btn btn-secondary">Tambah Produk</a>
                </div>
            </div>
                ...
                <table class="table table-striped table-hover align-middle">
                    ...
                    <?php foreach ($product as $prod) : ?>
                        ...
                        <tr>
                            ...
                            <td class="col-2">
                                <a href="hapusProduk.php?id=<?= $prod["id_produk"] ?>" class="btn btn-outline-danger" onclick="return confirm('yakin?');">hapus</a>
                                <a href="ubahProduk.php?id=<?= $prod["id_produk"] ?>" class="btn btn-primary">Ubah</a>
                            </td>
                        </tr>
