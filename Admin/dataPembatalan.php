...
$conn->query("UPDATE pembelian SET status_terima = 'Dibatalkan' WHERE id_pembelian = '$id_pembelian'");

$diterima = query("SELECT * FROM pembelian JOIN users ON pembelian.id_user = users.id WHERE pembelian.status_pembelian = 'Dibatalkan'");
