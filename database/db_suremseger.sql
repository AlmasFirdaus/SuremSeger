...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2604305998ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="240.19999980927">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_suremseger&table=pembelian">`db_suremseger`.`pembelian`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_suremseger&table=pembelian_produk">`db_suremseger`.`pembelian_produk`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_suremseger&table=users">`db_suremseger`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_suremseger&table=produk">`db_suremseger`.`produk`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_suremseger&table=pembayaran">`db_suremseger`.`pembayaran`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_suremseger&table=deskripsi">`db_suremseger`.`deskripsi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_suremseger&table=contact">`db_suremseger`.`contact`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_suremseger&table=about">`db_suremseger`.`about`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sakila&table=film">`sakila`.`film`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokokopi&table=users">`tokokopi`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="79574e335a27787724666f542f664f27">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom field-error" value="240.19999980927"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="db_suremseger" targettable="pembelian_produk">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `pembelian_produk`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_suremseger" targettable="pembelian">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `pembelian_produk`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_suremseger" targettable="produk">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `pembelian`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_suremseger" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
